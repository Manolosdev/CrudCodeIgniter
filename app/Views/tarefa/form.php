        ...
        <section  class="pricing_area pt-120 pb-40">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="descricao" placeholder="Informe a descrição" required maxlength="70" id="descricao" class="form-control" value="<?php echo isset($registro['descricao']) ? $registro['descricao'] : '' ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="form-group">
                            <label for="situacao_registro">Situação da tarefa</label>
                            <select class="form-control" id="situacao_registro" name="situacao_registro" required>
                                <option value="1" <?php echo isset($registro['situacao_registro']) && $registro['situacao_registro'] === 1 ? 'selected' : '' ?>>- Tarefa Pendente -</option>
                                <option value="2" <?php echo isset($registro['situacao_registro']) && $registro['situacao_registro'] === 2 ? 'selected' : '' ?>>- Tarefa Finalizada -</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="form-group">
                            <label for="fk_categoria">Categoria da tarefa</label>
                            <select class="form-control" id="fk_categoria" name="fk_categoria" required>
                                <option value="-1">- Selecione a categoria -</option>
                                <?php foreach ($categorias as $categoria): ?>
                                    <option value="<?php echo $categoria['id'] ?>" <?php echo isset($registro) && $registro['fk_categoria'] === $categoria['id'] ? 'selected' : '' ?>><?php echo $categoria['nome'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="form-group">
                            <label for="fk_responsavel">Responsavel pela tarefa</label>
                            <select class="form-control" id="fk_responsavel" name="fk_responsavel" required>
                                <option value="-1">- Selecione o responsavel -</option>
                                <?php foreach ($responsaveis as $responsavel): ?>
                                    <option value="<?php echo $responsavel['id'] ?>" <?php echo isset($registro) && $registro['fk_responsavel'] === $responsavel['id'] ? 'selected' : '' ?>><?php echo $responsavel['nome'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
